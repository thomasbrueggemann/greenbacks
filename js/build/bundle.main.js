...
},{"../alt":2,"lovefield":14,"md5":15,"moment":16}],2:[function(require,module,exports){
"use strict";
...
var Main = (function (_Component) {
	...
	_createClass(Main, [{
		...
		value: function componentDidMount() {
			_actionsRecordsActions2["default"].load();
		}
				...
				_react2["default"].createElement(
					...
					_react2["default"].createElement(
						...
						this.state.data.map(function (d, idx) {
							...
							return _react2["default"].createElement(_Row2["default"], { key: "row-" + idx, data: record });
						})
					)
				),
				_react2["default"].createElement(
...
},{"../actions/RecordsActions":1,"../stores/RecordsStore":10,"./Row":6,"papaparse":17,"react":"react"}],5:[function(require,module,exports){
"use strict";
...
var Row = (function (_Component) {
	...
	_createClass(Row, [{
		...
		value: function componentDidMount() {
			...
			var hash = (0, _md52["default"])(JSON.stringify(this.props.data));

			window.db.select().from(window.records).where(window.records.hash.eq(hash)).exec().then(function (results) {
				if (results.length > 0) {
					_this.setState({
						duplicate: true
					});
		...
		value: function render() {
			...
			return _react2["default"].createElement(
				...
				_react2["default"].createElement(
					"td",
					null,
					this.state.duplicate === false ? _react2["default"].createElement(_TagSelect2["default"], null) : null
				)
			);
		}
	}]);
...
},{"./TagSelect":7,"md5":15,"react":"react"}],7:[function(require,module,exports){
"use strict";
...
},{"./routes":9,"lovefield":14,"react":"react","react-dom":"react-dom","react-router":"react-router"}],9:[function(require,module,exports){
"use strict";
